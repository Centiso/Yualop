 ...
 * \brief Programme test du menu pause
 * \details Test du menus à part pour ne pas endommager le reste
...
* \brief Fonction erreur de la SDL
* \details Fonction de gestion d'erreur qui affiche l'erreur SDL rencontrée et libère la mémoire allouée avant de quitter le programme.
...
/**
* \fn clickSurCase
* \brief Test si la case est cliquée.
* \details Fonction testant si un clique a lieu dans le rectangle passé en paramètres.
* \param click L'évènement de cliquage
* \param caseRect La case à tester
* \return Ne retourne rien  
*/
...
* \brief Affiche une chaîne de caractère
* \details Fonction affichant un texte "str" sur le renderer aux coordonées passées en paramètres.
* \param *renderer Calque où sera placé le texte
* \param *police Choix de la police pour le texte
* \param *str Nom de la variable de texte
* \param x abscisse de l'emplacement du texte
* \param y ordonnée de l'emplacement du texte
* \return Ne retourne rien  c'est un void
*/
