 ...
 * \brief Contient le menu d'options de Yualop
...
/**
 * \fn SDL_bool menu_settings(SDL_Window *window, SDL_Renderer *renderer)
 * \brief Fonction affichant un menu d'option pour pouvoir jouer en plein écran ou en fenêtré.
 * \return SDL_True si l'utilisateur reste sur le jeu, SDL_False s'il souhaite le fermer.
 */
